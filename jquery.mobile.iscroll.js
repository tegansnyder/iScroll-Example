 ...
 * A little modified by Tegan Snyder - tegdesign.com
 * Changed SafariWindowHeightFix
 * iScroll 4 is the new one
 * set hScrollbar false
...
var SafariWindowHeightFix = -24; // XXX:
...
function fixed(elm) {
	...
	if (scroller) {
		var iscroll = new iScroll(scroller, {desktopCompatibility:true, fadeScrollbar: false, hideScrollbar: false, hScrollbar: false});
